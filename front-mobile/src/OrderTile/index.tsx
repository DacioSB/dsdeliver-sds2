...
const OrderTile = ({order}:Props) => {
  function calculaTotal(products: Product[], callback:any): number {
    let total = 0;
  ...
  return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.orderPrice}>{calculaTotal(order.products, (price : number) => (formatPrice(price)))}</Text>
            </View>
